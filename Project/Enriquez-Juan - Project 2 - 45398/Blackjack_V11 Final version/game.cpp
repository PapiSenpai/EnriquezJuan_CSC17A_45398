...
void Dealer(Deck &, Player *,Hand *,int, int &, int &, int &, int &);
void CheckSum(Player *,Hand *,int,int,int,int);
...
int main(int argc, char** argv) {
    ...
    while(answer!="N" && answer!="n"){
        //
        // if statement here if user wanted to restart game
        if(restart=="y" || restart=="Y")
        {
            ...
            // Statement to signify the first round
            cout<<"OK! Round " << round << " starts now!"<<endl<<endl;
        }//end of if statement
        //
        // Call the PlaceBets function so that we can place bets
        put.PlaceBets(p,numOfP);
        //
        //Create hand array of objects to load in cards
        load=new Hand[4];
        ...
        {    
            ...
            for(j=0;j<b;j++)
            {
              deck.PrintCard(load[1].getHand(j));
            }
            cout<<endl;
        }
        if(numOfP>=2)
        {
            ...
            for(j=0;j<c;j++)
            {
                deck.PrintCard(load[2].getHand(j));
            }
            cout<<endl;
        }
        if(numOfP>=3)
 ...
 ******************************************************************************/
void Dealer(Deck &deck, Player *p, Hand *l,int numOfP,int &a,
                                                    int &b, int &c, int &d)
{
    int choice,i,j;
 ...
 ******************************************************************************/
void CheckSum(Player *p,Hand *l,int numOfP, int b, int c, int d)
{
    int i;
    // if statement
    if(numOfP>=1)
...
{   
    ...
    {  
        ...
        {
            //if statement used to check every players score to see who won
