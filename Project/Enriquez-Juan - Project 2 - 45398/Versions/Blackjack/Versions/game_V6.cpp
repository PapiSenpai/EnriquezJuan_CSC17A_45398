...
Card draw(Deck &, int &);
void Dealer(Deck &, Player *, int &);
int CheckWin(Deck, Card, Player *,int);
...
void Dealer(Deck &d, Player *p, int &index)
{
    int choice;
...
int CheckWin(Deck d, Card c, Player *p,int numOfP)
{
