                                                    ...
                                                    int &b, int &c, int &d)
{
    ...
    while(choice!=4){
        ...
        if(choice==1)
        {
            p[1].setHand(deck, b,index);
            b++;
        }
        else if(choice==2)
        {
            p[2].setHand(deck, c,index);
            c++;
        }
        else if(choice==3)
        {
            p[3].setHand(deck, d,index);
            d++;
        }
        else
        {
    ...
    {      
        p[0].setHand(deck, a, index);
        deck.PrintCard(p[0].getHand(i));
        p[0].setTotal(a);
        // check other version is this gives weird output
        a++;
    }
    cout << p[0].getName() <<" has a value of " << total << endl;
}
...
//      p[1].total=total;
    ...
    if(numOfP>=2)
    {
        ...
        cout << p[2].getName() <<" has a value of " << p[2].getName() 
             << endl<<endl;
//        p[2].total=total;
    }
    if(numOfP>=3)
    {
        ...
        cout << p[3].getName() <<" has a value of " << p[3].getName() 
             << endl<<endl;
//        p[3].total=total;
    }   
}
