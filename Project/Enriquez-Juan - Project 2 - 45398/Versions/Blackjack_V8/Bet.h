        ...
        void PlaceBets(Player *p, int numOP)
        {
            ...
            if(answer=="Y" || answer=="y")
            {
                ...
                { 
                    ...
                    cin>>pep;
                    //make an if statement here to validate input
                    ...
                    if(pep==1)
                    {
                        ...
                        cout<<"Your new amount is "<<p[1].getCredit()<<endl;
                        lost[1]+=bet;
                    }
                    else if(pep==2)
                    {
                        ...
                        cout<<"Your new amount is "<<p[2].getCredit()<<endl;
                        lost[2]+=bet;  
                    }
                    else if(pep==3)
                    {
                        ...
                        cout<<"Your new amount is "<<p[3].getCredit()<<endl;
                        lost[3]+=bet;
                    }
                    // 
